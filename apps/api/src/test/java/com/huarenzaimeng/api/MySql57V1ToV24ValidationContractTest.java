...
class MySql57V1ToV24ValidationContractTest {
    private static final Path SCRIPT = Path.of("scripts/mysql57-validation/Invoke-MySql57V1ToV24Validation.ps1");
    private static final Path RUNBOOK = Path.of("../../docs/operations/mysql57-v1-v24-validation.md");
    ...
    @Test void scriptRequiresContinuousManifestAndBindsDatabaseServerAndVersionIdentity() throws Exception {
        String script = Files.readString(SCRIPT);
        assertThat(script)
                .contains("MIGRATION_MANIFEST_MUST_BE_CONTINUOUS_V1_TO_V24")
                ...
                .contains("24`t24`t24`t24`t0")
                .contains("V22_TERMINAL_OBJECT_MISMATCH", "V23_TERMINAL_OBJECT_MISMATCH", "V24_TERMINAL_OBJECT_MISMATCH")
    ...
    @Test void runbookCoversAllRequiredStartStatesIdempotencyAndInterruptedDdl() throws Exception {
        ...
        assertThat(runbook)
                ...
                .contains("V1→V24", "V15→V24", "V22→V24", "V24")
