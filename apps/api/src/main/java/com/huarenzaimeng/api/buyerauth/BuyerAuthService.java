...
final class BuyerAuthService {
    ...
    private static String safeUnknownProjectCode(String reason){return switch(reason==null?"":reason){
        ...
        case "WECHAT_PROVIDER_TLS_CERTIFICATE_FAILURE"->"WECHAT_PROVIDER_TLS_CERTIFICATE_FAILURE";
        case "WECHAT_PROVIDER_TLS_HANDSHAKE_FAILURE"->"WECHAT_PROVIDER_TLS_HANDSHAKE_FAILURE";
