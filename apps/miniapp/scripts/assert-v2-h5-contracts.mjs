...
for(const responsiveRule of ['height:100dvh','overflow:hidden','@media (max-height:900px)','@media (max-height:680px)'])assert.ok(home.includes(responsiveRule),`Home misses fixed-viewport rule: ${responsiveRule}`)
