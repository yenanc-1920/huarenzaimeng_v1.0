...
const directoryDisplay = read('src/domain/directory-display.ts')
assert.match(directoryDisplay, /LIFE_SERVICE:'生活服务'/, 'directory category LIFE_SERVICE must have Chinese copy')
assert.match(directoryDisplay, /MEDICAL:'医疗服务'/, 'directory category MEDICAL must have Chinese copy')
