...
export async function callProjectApi(path: string, method: Method, data?: unknown, bearer?: string): Promise<CloudContainerResult> {
  ...
  const header: Header = { 'X-WX-SERVICE': WECHAT_DEVELOPMENT_SERVICE, 'content-type': 'application/json' }
