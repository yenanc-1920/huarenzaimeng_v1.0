...
<section class="management-view" data-page-id="UX-A122" :data-visual-frame-id="activeTab==='HOLIDAY'?(mode==='LIST'?'A122':'A122-HOLIDAY'):'A122-NEWS'" data-data-origin="LOCAL_DATABASE">
