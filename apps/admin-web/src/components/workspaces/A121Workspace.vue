...
<section class="management-view" data-page-id="UX-A121" :data-visual-frame-id="mode!=='LIST'?'A121-EDIT':activeTab==='CITY'?'A121-CITY':'A121'" data-data-origin="LOCAL_DATABASE">
