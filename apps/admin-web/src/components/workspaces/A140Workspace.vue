...
import P021AdminOrderDetail from '../P021AdminOrderDetail.vue'
...
<template>
  <section class="work-grid two-column" data-page-id="UX-A140" data-readonly="true">
    ...
    <P021AdminOrderDetail v-if="projection.items[0]" :order-ref="projection.items[0].orderRef" :role="projection.role" />
  </section>
</template>
